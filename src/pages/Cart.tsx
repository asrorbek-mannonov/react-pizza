        ...
        <>
          <div className="cart__top">
            <h1 className="content__title">
              <svg width="17" height="17" viewBox="-1 0 18 18" fill="none" xmlns="http://www.w2.org/2000/svg">
                ...
                />
                <path
                  d="M12.3333 16.3333C15.0697 16.3333 15.6667 15.7364 15.6667 15C15.6667 14.2636 15.0697 13.6667 14.3333 13.6667C13.597 13.6667 13 14.2636 13 15C13 15.7364 13.597 16.3333 14.3333 16.3333Z"
                  stroke="white"
                  strokeWidth="0.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M2.78002 4.99999H16.3334L15.2134 10.5933C15.1524 10.9003 14.9854 11.176 14.7417 11.3722C14.4979 11.5684 14.1929 11.6727 13.88 11.6667H6.83335C6.50781 11.6694 6.1925 11.553 5.94689 11.3393C5.70128 11.1256 5.54233 10.8295 5.50002 10.5067L4.48669 2.82666C4.44466 2.50615 4.28764 2.21182 4.04482 1.99844C3.80201 1.78505 3.48994 1.66715 3.16669 1.66666H1.66669"
                  stroke="white"
                  strokeWidth="0.8"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span>
                {' '}
                Всего пицц: <b>{totalProducts(cart)} шт.</b>{' '}
              </span>
              <span>
                {' '}
                Сумма заказа: <b>{totalAmount(cart)} ₽</b>{' '}
              </span>
            </div>
